...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/craftaholic/vfox-zsh-syntax-highlighting"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache 2.0"
--- Plugin description
PLUGIN.description = "zsh-syntax-highlighting plugin for zsh using vfox"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/craftaholic/vfox-zsh-syntax-highlighting/releases/download/manifest/manifest.json"
